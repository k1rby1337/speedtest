...
def shell():
    ...
    printer('\033[01;34m[\033[01;34m+\033[01;34m] Încărcăm Serverele www.k1rby.ml... \033[01;34m[\033[01;34m+\033[01;34m]', quiet)
    try:
        speedtest = Speedtest()
    ...
    printer('\033[01;34m[\033[01;34m+\033[01;34m] Firma este : %(isp)s (%(ip)s)... \033[01;34m[\033[01;34m+\033[01;34m]' % speedtest.config['client'],quiet)
    if not args.mini:
#        printer('', quiet)
        try:
        ...
        printer('\033[01;34m[\033[01;34m+\033[01;34m] Căutăm Un Server Bazat... \033[01;34m[\033[01;34m+\033[01;34m]', quiet)
    ...
    printer('\033[01;34m[\033[01;34m+\033[01;34m] Hostat De %(sponsor)s (%(name)s) [%(d)0.2f km]: \033[01;34m[\033[01;34m+\033[01;34m] '
            '%(latency)s ms' % results.server, quiet)

    if args.download:
        printer('\033[01;34m[\033[01;34m+\033[01;34m] Testăm Viteza De Download... \033[01;34m[\033[01;34m+\033[01;34m]', quiet,
		end=('', '\n')[bool(debug)])
        speedtest.download(callback=callback)
        printer('\033[01;34m[\033[01;34m+\033[01;34m] Download: %0.2f M%s/s \033[01;34m[\033[01;34m+\033[01;34m]' %
    ...
    if args.upload:
        printer('\033[01;34m[\033[01;34m+\033[01;34m] Testăm Viteza De Upload... \033[01;34m[\033[01;34m+\033[01;34m]', quiet,
		end=('', '\n')[bool(debug)])
        speedtest.upload(callback=callback, pre_allocate=args.pre_allocate)
        printer('\033[01;34m[\033[01;34m+\033[01;34m] Upload: %0.2f M%s/s \033[01;34m[\033[01;34m+\033[01;34m]' %
